    ...
    .Does(() =>
{
    ...
    CleanDirectory("./src/Cofoundry.Plugins.DependencyInjection.Autofac/bin/");
    CleanDirectory("./src/Cofoundry.Plugins.DependencyInjection.Autofac.Web/bin/");
});
...
Task("Restore-NuGet-Packages")
    ...
    .Does(() =>
{
    NuGetRestore("./src/Cofoundry.Plugins.DependencyInjection.Autofac.sln");
});
